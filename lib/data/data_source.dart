...
Future<List<RestaurantModel>> getListOfRestaurants(BuildContext context, List<String?> list) async {
  var connectivityResult = await Connectivity().checkConnectivity();
  
  if (connectivityResult == ConnectivityResult.none) {
    // Tidak ada koneksi internet, tampilkan SnackBar
    ...
    // Throw Exception untuk memberitahu bahwa ada kesalahan
